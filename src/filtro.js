...
const filtrarMedicamentos = (filtro) => {
    console.log(filtro);
    const hoje = new Date();
    switch (filtro) {
        case "Mês Atual":
...
document.addEventListener("DOMContentLoaded", () => {
    const modal = document.getElementById("modal-fitro");
    const openBtn = document.getElementById("open-modal-filtro-vd");
    const closeBtn = document.getElementById("closed-filtro");
    ...
    const renderizarTabela = (dados) => {
        const tabelaBody = document.getElementById("medicamentos-tabela");
